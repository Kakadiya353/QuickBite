...
class _WalletState extends State<Wallet> {
  ...
  Future<void> loadUserData() async {
    userID =
        (await getUserId())!; // Make sure `getUserId()` works and returns a value.
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    if (userID.isNotEmpty) {
      ...
      fetchWalletBalance();
      getTransactionHistory();
      trigerNotification(addedAmount);
    }
  }
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 5.0),
                      Text("\$${(availableAmount as num).toStringAsFixed(2)}",
  ...
  void trigerNotification(addedAmount) {
    AwesomeNotifications().createNotification(
      content: NotificationContent(
        id: 10,
        channelKey: 'Basic_channel_v2',
        title: 'Wallet amount success',
        body: 'You\'r added ${addedAmount} 🫡✌️',
      ),
    );
  }
}
